...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { campaign_name, advertiser_name } = req.body || {};

    // Resolve advertiser_id (client_org_id is derived from the advertiser)
    ...
    const result = await sql`
      INSERT INTO campaigns (status, campaign_name, advertiser_id)
      VALUES ('draft', ${nameVal}, ${advertiser_id})
