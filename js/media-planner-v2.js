...
function mp2ShowResults() {
  ...
  ca.innerHTML = cardHeader + assetStrip +
    ...
    +       'Ad Analysis'
    +     '</button>'
    +     '<span style="width:1px;align-self:stretch;background:var(--border);margin:-10px 4px;flex-shrink:0"></span>'
